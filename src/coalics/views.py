...
from .util import event_acceptor, TimeoutException, parse_from
from .models import User, Calendar, CalendarSource, Event, db
from .forms import (
    CalendarForm,
    CalendarSourceForm,
    DeleteForm,
...
def init_views(app):
    ...
    def edit_source(cal_id, source_id):
        ...
        if request.method == "GET":
            ...
            return render_template(
                "source_edit.html", edit=True, form=form, cal_id=cal_id
            )
